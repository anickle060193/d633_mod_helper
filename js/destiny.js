...
{
    return flatten( $.map( activityData.extended.skullCategories, function( skullCategory )
    {
...
{
    var challenges = flatten( $.map( advisorData.activities.weeklyfeaturedraid.activityTiers, function( activityTier )
    {
        return flatten( $.map( activityTier.skullCategories, function( skullCategory )
        {
            return $.map( skullCategory.skulls, function( skull )
            {
                return skull.displayName;
